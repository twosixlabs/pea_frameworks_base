...
interface IPrivacyManager {
	List<ComponentName> getAvailableManagers();
	void setCurrentManager(in ComponentName privacyManager);
	ComponentName getCurrentManagerName();
	IPolicyManager getCurrentManager();
}
